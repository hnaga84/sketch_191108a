...
Minim minim;
AudioPlayer song,song2,song3,song4;
...
class Circle {
  ...
  void setBalls() {
    ...
    for (int i = 0; i < this.balls.size(); i++){ 
     ...
     balls.get(i).height = 10;
      balls.get(i).width = 10;
      balls.get(i).r = random(0, 255);
      balls.get(i).g = random(0, 255);
      balls.get(i).b = random(0, 255);
      println((float)i / 8);
      balls.get(i).vx = this.speed*cos(((float)i/this.balls.size())*3.7*2);
      balls.get(i).vy = this.speed*sin(((float)i/this.balls.size())*3.0*2);
      balls.get(i).ax = this.accel*cos(((float)i/this.balls.size())*3.7*2);
      balls.get(i).ay = this.accel*sin(((float)i/this.balls.size())*3.0*2);
    }
...
void setup() {
  ...
  song = minim.loadFile("hanabisakuretu.mp3");
  song2 = minim.loadFile("hanabisakuretu2.mp3");
  song3 = minim.loadFile("hanabisakuretu3.mp3");
  song4 = minim.loadFile("hanabisakuretu4.mp3");
  song.play();
  song2.play();
  song3.play();
  song4.play();
